...
export default function AboutSection() {
  ...
  const stats = [
    { icon: Award, label: "Projects Completed", value: "15+", color: "text-blue-600" },
    { icon: Users, label: "Years Learning", value: "3+", color: "text-purple-600" },
    ...
    <section id="about" className="py-20 px-4 sm:px-6 lg:px-8 bg-white dark:bg-slate-800 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="text-center mb-16 animate-on-scroll opacity-0 translate-y-10">
          ...
          <div className="w-24 h-1 bg-gradient-to-r from-blue-600 to-purple-600 mx-auto animate-expand" />
...
programming, UI/UX design and fixing real-world problems
                ...
                {stats.map((stat, index) => (
                  <div key={index} className="text-center group">
                    <div className="flex items-center justify-center mb-2">
                      <stat.icon className={`w-8 h-8 ${stat.color} group-hover:animate-bounce transition-transform`} />
                    </div>
          ...
          {/* Feature Cards */}
          <div className="grid grid-cols-2 gap-6 animate-on-scroll opacity-0 translate-x-[50px]">
            {features.map((item, index) => (
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  >
                    <item.icon
                      className={`w-8 h-8 bg-gradient-to-r ${item.color} bg-clip-text text-transparent group-hover:animate-bounce`}
                    />
                  </div>
                ...
                {/* Hover effect border */}
                <div
                  className={`absolute inset-0 rounded-xl bg-gradient-to-r ${item.color} opacity-0 group-hover:opacity-20 transition-opacity duration-300 blur-xl`}
                />
              </Card>
            ))}
          </div>
